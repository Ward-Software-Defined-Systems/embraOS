...
The shorter inventory of KG tools (as part of the broader 103-tool catalog) lives in [TOOL-REFERENCE.md](TOOL-REFERENCE.md). The architectural placement (the 7-layer model's *Memory & Knowledge* row) is in [SYSTEM-DESIGN.md](SYSTEM-DESIGN.md).
...
- [TOOL-REFERENCE.md](TOOL-REFERENCE.md) — catalog of all 103 tools the intelligence draws from (the **Knowledge Graph** table covers these twelve).
