...
- [TOOL-REFERENCE.md](TOOL-REFERENCE.md) — All 116 built-in tools by category, plus workspace/GitHub/SSH safety notes.
...
- [KNOWLEDGE-GRAPH.md](KNOWLEDGE-GRAPH.md) — Cross-session memory graph: auto-derived edges, density rationale, promotion path, auto-enrichment, retrieval ranking, the in-OS semantic-similarity layer, the 12 `knowledge_*` tools.
