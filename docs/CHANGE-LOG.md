...
`main` advanced past `v0.5.0-phase1` with nine post-Sprint-5 increments through 2026-05-24. Counts after the increments: 92 tools (90 → 92 at the embra-guardian-v1 merge for the `guardian_call`/`guardian_list` meta-tools); embra-brain 439 tests / embra-console 21 / embra-guardian 52; workspace 9 → 11 members; no version bump from `0.5.0-phase1`.
