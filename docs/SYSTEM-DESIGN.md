...
| **Influence & Propagation** | Tool dispatch, LLM provider routing, Guardian dynamic-tool gateway. | `crates/embra-brain/src/{tools,provider,guardian}/`; 103 tools, 4 providers |
...
| `embra-brain` | 50002 | LLM runtime — provider abstraction, 103 tools, session manager, knowledge graph, Learning Mode. |
