...
| **Influence & Propagation** | Tool dispatch, LLM provider routing, Guardian dynamic-tool gateway. | `crates/embra-brain/src/{tools,provider,guardian}/`; 102 tools, 4 providers |
...
| `embra-brain` | 50002 | LLM runtime — provider abstraction, 102 tools, session manager, knowledge graph, Learning Mode. |
